...
/**
 * Sample server list adapter.
 */
public class SampleServerListAdapter extends RecyclerView.Adapter<SampleServerListAdapter.ViewHolder> {
    ...
    public SampleServerListAdapter(Context context, @NonNull SampleServerIndirectList list, @NonNull OnItemClickListener listener) {
        super();
