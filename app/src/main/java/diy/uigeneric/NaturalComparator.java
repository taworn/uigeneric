 ...
 * A natural comparator of two strings.
 *
 * Just change name by alpha numeric comparator.
...
public class NaturalComparator implements Comparator<String> {
     ...
     */
    public NaturalComparator(Comparator<? super String> collator) {
     ...
     */
    public static NaturalComparator forLocale(Locale locale) {
        Collator collator = Collator.getInstance(locale);
        collator.setDecomposition(Collator.NO_DECOMPOSITION);
        collator.setStrength(Collator.PRIMARY);
        return new NaturalComparator(collator);
    }
